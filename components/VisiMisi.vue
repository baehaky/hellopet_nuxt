      ...
      <div class="flex flex-col justify-center">
        ...
        <div class="bg-[#16BDCA] w-[350px] md:w-[400px] p-5 rounded-md">
          ...
          <div class="flex justify-center mt-4">
            <img
              src="@/public/assets/images/HELLOPET! 1.png"
              alt="Cat and Dog"
              class="w-35 h-auto"
            />
          </div>
        ...
        <div class="bg-[#16BDCA] w-[350px] md:w-[400px] p-5 rounded-md py-8">
          <ol class="list-decimal list-inside text-justify text-white">
            <li>
              ...
              pengetahuan pemilik hewan tentang perawatan yang berkualitas.
            </li>
            <li>
              Menjalin kerja sama dengan klinik dan dokter hewan untuk
              memastikan kualitas layanan yang terbaik.
            </li>
            <li>
              Membangun komunitas pecinta hewan peliharaan yang saling terhubung
              melalui teknologi dan informasi terpercaya.
            </li>
          </ol>
        </div>
      </div>
